...
export const projects: Project[] = [
	...
	{
		title: 'Date My Globe',
		description: "A checklist for estimating a globe's age from visible borders and place names.",
		href: '/projects/date-my-globe',
		label: 'date-my-globe',
		external: false,
		featured: false,
		accent: '#83b8a1',
	...
	{
		title: 'LLMs 101',
		description: 'An interactive, non-technical walkthrough of how large language models work.',
		href: '/projects/llms-101',
		label: 'llms-101',
		external: false,
		featured: false,
		accent: '#84a6d8',
